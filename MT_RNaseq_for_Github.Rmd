...
volcano_res.swap.AetF.all <- ggplot(data=res.swap.AetF.all.copy, 
                              ...
                              xlim(-10,10)+
                              ylim(-1,32)+
                              ggtitle("Ae. taeniorhnchus (field)")
...
# plotting the two volcano plots side by side

```{r side-by-side_volcano_plots}

plot_grid(volcano_res.swap.AegF.all, volcano_res.swap.AetF.all, labels = "AUTO")
